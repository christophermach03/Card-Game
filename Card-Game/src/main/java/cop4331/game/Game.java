...
import java.util.*;
/**
 *Is the actual game logic the runs everything server-side
 * @author chris
 */
public class Game {
    ...
    /**
     *Adds the bomb cards to the deck afterwards
     */
    ...
    /**
     *fills each players hands with cards drawn from the deck
     */
    ...
    /**
     *Adds a player to the player list and instantiates a reference to
     * the game and stack in them.
    ...
    /**
     *returns player based on id by searching through the playerlist
     * @param id
     * @return the player
     */
    ...
    /**
     *each time a card is drawn, the game checks for a winner
